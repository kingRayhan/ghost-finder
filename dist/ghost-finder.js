...
var GhostFinder = function GhostFinder(_ref) {
  ...
  var _ref$selector = _ref.selector,
      ...
      _ref$contentApiKey = _ref.contentApiKey,
      contentApiKey = _ref$contentApiKey === void 0 ? null : _ref$contentApiKey,
      homeUrl = _ref.homeUrl,
      _ref$fields = _ref.fields,
      fields = _ref$fields === void 0 ? 'title,slug,html' : _ref$fields,
      showResult = _ref.showResult,
      resultTemplate = _ref.resultTemplate,
      singleResultTemplate = _ref.singleResultTemplate,
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return _this.api.posts.browse({
                limit: 'all',
                fields: "".concat(_this.fields.split(',').includes('excerpt') ? _this.fields + ',html' : _this.fields),
            ...
            case 3:
              ...
              if (_this.searchTerm.length === 0) {
                ...
                result = filteredPosts.map(function (post) {
                  ...
                  if (fieldsArray.includes('created_at') || fieldsArray.includes('updated_at')) {
                    if (post.created_at) {
                      replacerObj['created_at'] = moment__WEBPACK_IMPORTED_MODULE_3___default()(post.created_at).format(_this.time_format);
                    }

                    if (post.updated_at) {
                      replacerObj['updated_at'] = moment__WEBPACK_IMPORTED_MODULE_3___default()(post.updated_at).format(_this.time_format);
                    }
                  }
                  /**
                  ...
                  var varIsNot = ['excerpt', 'created_at', 'updated_ta'];
                  fieldsArray.forEach(function (variable) {
                    if (!varIsNot.includes(variable)) replacerObj[variable] = post[variable];
                  });
