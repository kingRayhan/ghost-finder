...
var GhostSearch = function GhostSearch(_ref) {
  ...
  this.allReplace = function (retStr, obj) {
    for (var x in obj) {
      retStr = retStr.replace("##".concat(x), obj[x]);
    }
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              console.log(posts); // if searchTerm's length is less then 1 character then stop here...
              ...
              if (_this.searchTerm.length === 0) {
                ...
                result = filteredPosts.map(function (post) {
                  ...
                  _this.fields.split(',').forEach(function (variable) {
